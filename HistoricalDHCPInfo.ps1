...
Intent: Create an offline file full of historical DHCP information for comparison with ACAS
Changes: 
- Implemented method to create the LeaseStartTime
- Added a column for the DHCP server name
...
$error | export-csv "errors.csv" -notypeinformation
